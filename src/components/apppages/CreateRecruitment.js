...
const CreateRecruitment = () => {
  ...
  const handleSubmit = (e) => {
    ...
    bodyFormData.append('company_logo_image', logo, logo.name);
    bodyFormData.append('company_banner_image', banner, banner.name);
 ...
 const closeModal = () => {
      ...
      return <Redirect to="/pages/recruiter"/>
    }
  return (
    <>
