...
let requestUpdate = {
            ...
            company_logo_image: logo,
            company_banner_image: banner,
        ...
        fetch("http://139.59.35.110/castclass/api/v2/companies/" + itemData.id + "?default_user=" + localStorage.getItem('default_user'), {
            method: 'PUT',
            headers: {
